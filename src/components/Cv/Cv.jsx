      ...
      <div className="main">
        <div className="section">
          <div className="name">
            <div className="header">
              <div className="text">
                <h1>Doğu Kemal Sezen</h1>
                <h2>Hakkımda</h2>
                <p>
                  Dış görünümüne önem veren, Mesleki Çalışma Alanındaki
                  Teknolojik Aletleri Kullanmaya Yatkınlığı Olan, İnsan
                  İlişkilerinde Anlayışlı ve Kibar Davranan, Takım Liderliği,
                  Proje Yönetimi, Sunum Becerileri, Çalışkan, Planlı, Verilen
                  İşi Etkin ve Zamanında Yerine Getiren, Yenilikçi, Hedefleri
                  Olan, Kararlı, Takım Çalışmasına Uyumlu, Üretken, Sabırlı,
                  Hırslı, Disiplinli, Misafir Odaklı, İleri Görüşlü, Neşeli,
                  Esprili, Güler Yüzlü, Saygılı, Enerjik, Diksiyonu Düzgün.
                </p>
              </div>
              <div className="img">
                <img className="photo" src={photo} alt="Dogu photo" />
              </div>
            </div>
            <div className="langs">
              <h2>Yabancı Dil</h2>
              <ul>
                <li className="lang">
                  <div className="lang-text">
                    <div className="lang-name">İngilizce</div>
                  </div>
                  <div className="stars">
                    <ul>
                ...
                <li className="lang">
                  <div className="lang-text">
                    <div className="lang-name">Almanca</div>
                  </div>
                  <div className="stars">
                    <ul>
                      <li className="star-full">
                ...
                <li className="lang">
                  <div className="lang-text">
                    <div className="lang-name">Rusça</div>
                  </div>
                  <div className="stars">
                    <ul>
                      <li className="star-full">
        ...
        <div className="section">
          <div>
            ...
            <ul className="item-list">
              ...
              <li className="item">
                <div className="left-content">
                  <h4 className="position">Satış Danışmanı</h4>
                </div>
                <div className="right-content">
              ...
              <li className="item">
                <div className="left-content">
                  <h4 className="position">Eğlence Müdür Asistanı</h4>
                </div>
                <div className="right-content">
              ...
              <li className="item">
                <div className="left-content">
                  <h4 className="position">Eğlence Sorumlusu</h4>
                </div>
                <div className="right-content">
        ...
        <div className="section">
          ...
          <ul className="item-list">
            <li className="item">
              <div className="left-content">
                <h4 className="position">Turizm ve Rehberlik</h4>
              </div>
              <div className="right-content">
        ...
        <div className="section">
          <ul className="item-list">
            <li className="item">
              <div className="left-content">
                <h4 className="position">Eğitim</h4>
              </div>
              <div className="right-content">
                <div className="firm">İlkyardım</div>
                <div className="firm">Kalite ve çevre yönetimi</div>
                <div className="firm">İSG</div>
              </div>
            </li>
          </ul>
        </div>
